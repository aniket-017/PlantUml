  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-800">Refine Your Diagram</h1>
        ...
        <div className="order-2 lg:order-1">
          <div className="bg-white rounded-lg shadow-md h-[600px] flex flex-col">
            <div className="p-4 border-b border-gray-200">
              ...
              <p className="text-sm text-gray-600">Ask me to modify your diagram</p>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              {state.chatHistory.length === 0 ? (
                <div className="text-center text-gray-500 py-8">
                  ...
                  <p className="text-sm mt-2">Try asking me to add actors, modify flows, or improve the structure.</p>
                </div>
              ) : (
          ...
          {state.chatHistory.length === 0 && (
            <div className="mt-4 bg-blue-50 rounded-lg p-4">
              <h3 className="text-sm font-semibold text-blue-800 mb-2">Suggested prompts:</h3>
        ...
        <div className="order-1 lg:order-2">
          <div className="bg-white rounded-lg shadow-md">
            <div className="p-4 border-b border-gray-200">
              ...
              <p className="text-sm text-gray-600">Updates automatically as you chat</p>
            </div>
          ...
          <div className="mt-4 bg-gray-50 rounded-lg p-4">
            <h4 className="font-semibold text-gray-800 mb-2">💡 Chat Tips</h4>
